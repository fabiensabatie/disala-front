...
export const NavBar = () => {
    ...
    return (
        <div className="h-screen hidden lg:block my-4 ml-4 shadow-lg relative w-80" style={{height: "calc(100vh - 2rem)"}}>
            <nav className="max-h-full overflow-y-scroll no-scrollbar bg-white h-full rounded-2xl">
                <a className="w-full font-bold text-blue-500 flex items-center p-4 my-2 transition-colors duration-200 justify-start bg-gradient-to-r from-white to-blue-100 border-r-4 border-blue-500 " href="#">
                ...
                <a className="w-full font-bold text-blue-500 flex items-center p-4 my-2 transition-colors duration-200 justify-start" href="#">
                    <span className="text-left">
                        <svg width="20" height="20" fill="currentColor" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1070 1178l306-564h-654l-306 564h654zm722-282q0 182-71 348t-191 286-286 191-348 71-348-71-286-191-191-286-71-348 71-348 191-286 286-191 348-71 348 71 286 191 191 286 71 348z">
                            </path>
                ...
                <a className="w-full font-bold text-gray-500 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500" href="#">
                    <span className="text-left">
